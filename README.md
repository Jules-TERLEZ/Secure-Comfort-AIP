...
- Sécuriser les données dans une base de données
...
## Stockage des données chiffrées dans la base de données
<img width="1453" height="819" alt="image" src="https://github.com/user-attachments/assets/707c3076-d937-438c-9e51-c890e56282bf" />
